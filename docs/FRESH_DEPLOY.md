...
CORS_ORIGINS=https://crm.malwatrolley.com,http://200.97.171.119:8010
SEED_ADMIN_EMAIL=admin@malwatrolley.com
SEED_ADMIN_PASSWORD=Malwa#8224
MTCRM_API_PORT=8010
```

Firewall: allow TCP **8010**

Check: `http://200.97.171.119:8010/api/health/live` → build_id `fresh-20260722`
...
Frontend talks **direct** to API: `http://200.97.171.119:8010/api`  
(no PHP bridge)
